      ...
      <div style={{ padding: 20 }}>
        ...
        <div style={formBox}>
          ...
          <select
            ...
            onChange={(e) =>
              setCreatingTeam({ ...creatingTeam, division: e.target.value })
            }
          >
          ...
          <select
            ...
            onChange={(e) =>
              setCreatingTeam({ ...creatingTeam, coach_id: e.target.value })
            }
          >
          ...
          <select
            ...
            onChange={(e) =>
              setCreatingTeam({ ...creatingTeam, assistant_coach_id: e.target.value })
            }
          >
    ...
    return (
      <div style={{ padding: 20 }}>
        ...
        <div style={dashboardCard}>
          ...
          <div>
            ...
            <div style={{ marginTop: 10 }}>
              <div><strong>Coach:</strong> {getCoachName(activeTeam.coach_id)}</div>
        ...
        <div style={actionBar}>
          ...
          <button style={primaryBtn} onClick={autoRoster}>
            ⚡ Auto Roster
          </button>
        </div>
            ...
            {players
              ...
              .map(p => (
                <div key={p.id} style={row}>
                  ...
                  <button style={primaryBtn} onClick={() => addPlayerToTeam(p.id)}>
                    Add
                  </button>
                </div>
              ))}
        ...
        <div style={table}>
          {teamPlayers.map(p => (
            <div key={p.id} style={tableRow}>
              <div>{p.first_name} {p.last_name}</div>
              <button style={removeBtn} onClick={() => removeFromTeam(p.id)}>
                Remove
              </button>
            </div>
          ))}
